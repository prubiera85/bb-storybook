import{d as H}from"./index-154de5b0.js";(function(){try{var r=typeof E<"u"?E:typeof I<"u"?I:typeof self<"u"?self:{},e=new Error().stack;e&&(r._sentryDebugIds=r._sentryDebugIds||{},r._sentryDebugIds[e]="1f1ea341-cd53-452f-8a3e-6a2b6547b70e",r._sentryDebugIdIdentifier="sentry-dbid-1f1ea341-cd53-452f-8a3e-6a2b6547b70e")}catch{}})();const{useEffect:A,useMemo:h}=__STORYBOOK_MODULE_PREVIEW_API__,{global:I}=__STORYBOOK_MODULE_GLOBAL__,{logger:K}=__STORYBOOK_MODULE_CLIENT_LOGGER__;var p="backgrounds",C={light:{name:"light",value:"#F8F8F8"},dark:{name:"dark",value:"#333"}},{document:b,window:E}=I,D=()=>{var r;return!!((r=E==null?void 0:E.matchMedia("(prefers-reduced-motion: reduce)"))!=null&&r.matches)},B=r=>{(Array.isArray(r)?r:[r]).forEach(P)},P=r=>{var d;let e=b.getElementById(r);e&&((d=e.parentElement)==null||d.removeChild(e))},z=(r,e)=>{let d=b.getElementById(r);if(d)d.innerHTML!==e&&(d.innerHTML=e);else{let n=b.createElement("style");n.setAttribute("id",r),n.innerHTML=e,b.head.appendChild(n)}},U=(r,e,d)=>{var a;let n=b.getElementById(r);if(n)n.innerHTML!==e&&(n.innerHTML=e);else{let t=b.createElement("style");t.setAttribute("id",r),t.innerHTML=e;let i=`addon-backgrounds-grid${d?`-docs-${d}`:""}`,o=b.getElementById(i);o?(a=o.parentElement)==null||a.insertBefore(t,o):b.head.appendChild(t)}},j={cellSize:100,cellAmount:10,opacity:.8},G="addon-backgrounds",R="addon-backgrounds-grid",X=D()?"":"transition: background-color 0.3s;",N=(r,e)=>{let{globals:d,parameters:n,viewMode:a,id:t}=e,{options:i=C,disable:o,grid:s=j}=n[p]||{},c=d[p]||{},u=c.value,l=u?i[u]:void 0,$=(l==null?void 0:l.value)||"transparent",m=c.grid||!1,y=!!l&&!o,f=a==="docs"?`#anchor--${t} .docs-story`:".sb-show-main",_=a==="docs"?`#anchor--${t} .docs-story`:".sb-show-main",F=n.layout===void 0||n.layout==="padded",L=a==="docs"?20:F?16:0,{cellAmount:k,cellSize:g,opacity:x,offsetX:v=L,offsetY:S=L}=s,M=a==="docs"?`${G}-docs-${t}`:`${G}-color`,w=a==="docs"?t:null;A(()=>{let T=`
    ${f} {
      ...
      `;z(O,Y)},[k,g,_,O,m,v,S,x]),r()},W=(r,e=[],d)=>{if(r==="transparent")return"transparent";if(e.find(a=>a.value===r)||r)return r;let n=e.find(a=>a.name===d);if(n)return n.value;if(d){let a=e.map(t=>t.name).join(", ");K.warn(H`
        Backgrounds Addon: could not find the default color "${d}".
        These are the available colors for your story based on your configuration:
        ${a}.
      `)}return"transparent"},q=(r,e)=>{var u;let{globals:d,parameters:n}=e,a=(u=d[p])==null?void 0:u.value,t=n[p],i=h(()=>t.disable?"transparent":W(a,t.values,t.default),[t,a]),o=h(()=>i&&i!=="transparent",[i]),s=e.viewMode==="docs"?`#anchor--${e.id} .docs-story`:".sb-show-main",c=h(()=>`
      ${s} {
        background: ${i} !important;
        ${D()?"":"transition: background-color 0.3s;"}
      }
    `,[i,s]);return A(()=>{let l=e.viewMode==="docs"?`addon-backgrounds-docs-${e.id}`:"addon-backgrounds-color";if(!o){B(l);return}U(l,c,e.viewMode==="docs"?e.id:null)},[o,c,e]),r()},J=(r,e)=>{var y;let{globals:d,parameters:n}=e,a=n[p].grid,t=((y=d[p])==null?void 0:y.grid)===!0&&a.disable!==!0,{cellAmount:i,cellSize:o,opacity:s}=a,c=e.viewMode==="docs",u=n.layout===void 0||n.layout==="padded"?16:0,l=a.offsetX??(c?20:u),$=a.offsetY??(c?20:u),m=h(()=>{let f=e.viewMode==="docs"?`#anchor--${e.id} .docs-story`:".sb-show-main",_=[`${o*i}px ${o*i}px`,`${o*i}px ${o*i}px`,`${o}px ${o}px`,`${o}px ${o}px`].join(", ");return`
      ${f} {
